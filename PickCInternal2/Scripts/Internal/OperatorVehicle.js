...
function btnSaveVehicle() {
    ...
    if (gIndex != -1) {
        debugger;
        var baseID = 'OPerator_OperatorVehicleList_' + gIndex + '__';
        ...
        var html = '<tr id="trRow_Vehicle_' + index + '">' +
                        '<td>' +
                            ...
                            '<input class="vehicleNoCss" id="OPerator_OperatorVehicleList_' + index + '__VehicleRegistrationNo" name="OPerator.OperatorVehicleList[' + index + '].VehicleRegistrationNo" type="hidden" value="' + $('#operatorVehicle_VehicleRegistrationNo').val() + '">' +
                        '</td>' +
                        '<td>' +
                            '<span id="operatorVehicle_VehicleType_span_' + index + '">' + $("#operatorVehicle_VehicleType option:selected").text() + '</span>' +
                            '<input id="OPerator_OperatorVehicleList_' + index + '__VehicleType" name="OPerator.OperatorVehicleList[' + index + '].VehicleType" type="hidden" value="' + $("#operatorVehicle_VehicleType").val() + '">' +
                        '</td>' +
                        '<td>' +
                            '<span id="operatorVehicle_VehicleCategory_span_' + index + '">' + $("#operatorVehicle_VehicleCategory option:selected").text() + '</span>' +
                            '<input id="OPerator_OperatorVehicleList_' + index + '__VehicleCategory" name="OPerator.OperatorVehicleList[' + index + '].VehicleCategory" type="hidden" value="' + $("#operatorVehicle_VehicleCategory option:selected").val() + '">' +
                        '</td>' +
                         '<td>' +
                            '<span id="operatorVehicle_Model_span_' + index + '">' + $('#operatorVehicle_Model').val() + '</span>' +
                            '<input id="OPerator_OperatorVehicleList_' + index + '__Model" name="OPerator.OperatorVehicleList[' + index + '].Model" type="hidden" value="' + $('#operatorVehicle_Model').val() + '">' +
                        '</td>' +
                         '<td>' +
                            '<span id="operatorVehicle_Tonnage_span_' + index + '">' + $('#operatorVehicle_Tonnage').val() + '</span>' +
                            '<input id="OPerator_OperatorVehicleList_' + index + '__Tonnage" name="OPerator.OperatorVehicleList[' + index + '].Tonnage" type="hidden" value="' + $('#operatorVehicle_Tonnage').val() + '">' +
                        '</td>' +
                        '<td>' +
