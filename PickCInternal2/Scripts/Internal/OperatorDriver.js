    ...
    if (gIndex != -1) {
        ...
        var html = '<tr id="trRow_Driver_' + index + '">' +
                        '<td>' +
                            ...
                            '<input id="OPerator_OperatorDriverList_' + index + '__DriverName" name="OPerator.OperatorDriverList[' + index + '].DriverName" type="hidden"  value="' + $('#operatorDriverList_DriverName').val() + '">' +
                        '</td>' +
                        '<td>' +
                            '<span id="operatorDriverList_DriverLicenseNo_span_' + index + '">' + $('#operatorDriverList_DriverLicenseNo').val() + '</span>' +
                            '<input id="OPerator_OperatorDriverList_' + index + '__DriverLicenseNo" name="OPerator.OperatorDriverList[' + index + '].DriverLicenseNo" type="hidden" value="' + $('#operatorDriverList_DriverLicenseNo').val() + '">' +
                        '</td>' +
                         '<td>' +
                            '<span id="operatorDriverList_DriverMobileNo_span_' + index + '">' + $('#operatorDriverList_DriverMobileNo').val() + '</span>' +
                            '<input id="OPerator_OperatorDriverList_' + index + '__DriverMobileNo" name="OPerator.OperatorDriverList[' + index + '].DriverMobileNo" type="hidden" value="' + $('#operatorDriverList_DriverMobileNo').val() + '">' +
                        '</td>' +
                         '<td>' +
                            '<span id="operatorDriverList_VehicleNo_span_' + index + '">' + $('#operatorDriverList_VehicleNo').val() + '</span>' +
                            '<input id="OPerator_OperatorDriverList_' + index + '__VehicleNo" name="OPerator.OperatorDriverList[' + index + '].VehicleattachedNo" type="hidden" value="' + $('#operatorDriverList_VehicleNo').val() + '">' +
                        '</td>' +
                        '<td>' +
